...
public class CreacionCalculadora extends javax.swing.JFrame {

    /**
     * Creates new form CreacionCalculadora
     */
    public CreacionCalculadora() {
        initComponents();
    }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(numero2, javax.swing.GroupLayout.DEFAULT_SIZE, 108, Short.MAX_VALUE)
  ...
  double num1 = Double.parseDouble(numero1.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreacionCalculadora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreacionCalculadora().setVisible(true);
            }
        });
    }
